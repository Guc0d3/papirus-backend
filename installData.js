const accountings = [
  ...
  { companyId: -2, code: '1101', name: 'เงินสด', isSafe: true },
  { companyId: -2, code: '1201', name: 'เงินฝากธนาคาร', isSafe: true },
  { companyId: -2, code: '1301', name: 'ลูกหนี้การค้า', isSafe: true },
  { companyId: -2, code: '1401', name: 'สินค้าคงเหลือ', isSafe: true },
  {
    companyId: -2,
    code: '1501',
  ...
  { companyId: -2, code: '2101', name: 'เจ้าหนี้การค้า', isSafe: true },
  { companyId: -2, code: '2201', name: 'ภาษีขาย', isSafe: true },
  {
    companyId: -2,
    code: '2301',
  ...
  { companyId: -2, code: '3101', name: 'ทุน', isSafe: true },
  { companyId: -2, code: '3201', name: 'กำไรสะสม', isSafe: true },
  { companyId: -2, code: '3301', name: 'เงินปันผล', isSafe: true },
  { companyId: -2, code: '4101', name: 'รายได้', isSafe: true },
  { companyId: -2, code: '4201', name: 'ดอกเบี้ย', isSafe: true },
  { companyId: -2, code: '5101', name: 'ต้นทุนการขาย', isSafe: true },
  { companyId: -2, code: '5201', name: 'ซื้อสินค้า', isSafe: true },
  { companyId: -2, code: '5301', name: 'ส่วนลด', isSafe: true },
  { companyId: -2, code: '5401', name: 'เงินเดือน', isSafe: true },
  { companyId: -2, code: '5501', name: 'ค่าโฆษณา', isSafe: true },
  { companyId: -2, code: '5601', name: 'รายจ่ายสำนักงาน', isSafe: true },
  {
    companyId: -2,
    code: '5701',
  ...
  { companyId: -2, code: '5702', name: 'ดอกเบี้ยจ่าย', isSafe: true },
  { companyId: -2, code: '5801', name: 'ค่าเสื่อมราคา', isSafe: true }
]
